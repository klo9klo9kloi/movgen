...
for epoch in range(start_epoch, opt.niter + opt.niter_decay + 1):
    ...
    for i, data in enumerate(dataset, start=epoch_iter):
        ...
        # if save_fake:
        #     visuals = OrderedDict([('input_label', util.tensor2label(data['label'][0, :opt.label_nc, :, :], opt.label_nc)),
        #                            ('synthesized_image', util.tensor2im(generated.data[0, :opt.output_nc, :, :])),
        #                            ('real_image', util.tensor2im(data['image'][0, :opt.output_nc, :, :]))])
